export default class Problem {
    ...
    constructor() {
        ...
        // 给tbody绑定点击事件,利用事件委托,将所有子元素点击事件,都委托给它
    ...
    distribute(eve) {
        ...
        // 判断点击的是否是删除按钮,是则调用删除的方法
        if (tar.classList.contains('btn-del')) this.delDate(tar);

        // 判断点击的是否为修改按钮,是则调用修改的方法
        if (tar.classList.contains('btn-modify')) this.modifyDate(tar);
    }
                ...
                data.forEach(ele => {
                    ...
                    */
                    ...
                    <td>
                        ...
                        <span class="glyphicon glyphicon-edit  btn-modify" aria-hidden="true"></span>
                        </button>
                    </td>
                </tr>`
                });
